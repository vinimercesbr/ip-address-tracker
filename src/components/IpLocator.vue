<template>
  <div id="card" class="m-11 desktop:-mr-4 ml-8 -mt-12 mobile:inline-flex absolute p-1 bg-white  rounded-xl items-center justify-items-center font-semibold text-center mobile:max-h-[60vh]  min-w-[80%] touch-none">
    <div class="manager">
      <a>IP ADDRESS</a>
      <strong>
        {{ ipData.ip }}
