<template>
  <div id="banner" class="items-center text-center   touch-none p-6 max-mobile:p-0 m-0 desktop:h-full -mr-5 desktop:w-full  max-mobile:h-[30vh] bg-[url('/pattern-bg-desktop.png')] max-mobile:bg-[url('/pattern-bg-mobile.png')]">
