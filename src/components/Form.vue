<template>
  <div id="banner" class="items-center text-center   touch-none p-6 max-mobile:p-0 m-0 desktop:h-full -mr-5 desktop:min-w-[100%] max-mobile:h-[30vh] bg-[url('/pattern-bg-desktop.png')] max-mobile:bg-[url('/pattern-bg-mobile.png')]">
    <h1 class="text-white p-3 max-mobile:p-5 text-center -ml-2 font-semibold text-[25px] touch-none">IP Address Tracker</h1>
    <form class="search-form text-center flex desktop:w-[70%] desktop:h-[25%] pt-0 ml-2 desktop:m-2 desktop:inline-flex mt-2 p-5 mb-5" @submit.prevent="submitForm">
      ...
      <button class="search-form__button rounded-r-xl stroke-2 -mr-7 h-[55px] p-4 bg-black" type="submit">
