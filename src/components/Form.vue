<template>
  <div id="banner" class="items-center text-center   touch-none p-6 mobile:p-1 m-0 desktop:h-full -mr-5 desktop:min-w-[100%] max-mobile:h-[30vh] bg-[url('/pattern-bg-desktop.png')] bg-cover mobile:bg-[url('/pattern-bg-mobile.png')]">
